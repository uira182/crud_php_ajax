...
} else if (isset($json->addnome)) {
    $resultado = mysqli_query($conexao, "INSERT INTO cliente (nome, telefone, celular, email) VALUES ('" . $json->addnome . "', '" . $json->addtel . "', '" . $json->addcel . "', '" . $json->addemail . "')");
    if (!$resultado) {
        echo "<script>alert('Erro');</script>";
    } else {
        echo "<script>alert('Inserido com Sucesso!');</script>";
    }
} else if (isset($json->del)) {
